    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(Login login)
        {
            if (ModelState.IsValid)
            {
                ...
                if (success == true)
                {
                    ...
                    {
                        ModelState.AddModelError("Error", "Los Derechos al Usuario Aún no han Sido Proporcionado. Favor Contactar al Administrador");
                        return View(login);
                    }
                    else
                    {
                ...
                {
                    ModelState.AddModelError("Error", "Ingrese un Nombre de Usuario y una Contraseña Válida");
                    return View(login);
                }
            }
            else
        ...
        public ActionResult RoleCreate(Role role)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("Error", "El Nombre de Rol ya Existe");
                    return View(role);
                }
                else
                {
        ...
        public ActionResult Changepassword(ChangepasswordVM VM)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    if (value == false)
                    {
                        ModelState.AddModelError("Error", "Contraseña Antigua Incorrecta");
                        return View(VM);
                    }
                    else
                    {
                        ViewBag.ResultMessage = "Contraseña Cambiada con Éxito";
                    }
            ...
            {
                ModelState.AddModelError("Error", "Rellenar Campos");
            }
            return View(VM);
        }
